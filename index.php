        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body text-center">
              <h4 class="title mb-2">Vtex R$10</h4>
...
*/
      ...
      if (total > 1000) {
        Swal.fire({
          title: 'Limite de 1K de Linhas Exedido!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000
        });
        return false;
      }
